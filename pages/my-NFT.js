...
export default function myNFT() {
  ...
  if (loadState === "loaded" && !NFTS.length) return (<h1 className="py-10 px-20 text-3xl">No assets owned</h1>)
    ...
    <div className="flex justify-center text-blue-300">
      <div className="p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
          {NFTS.map((nft, i) => (
            <div key={i} className="border shadow rounded-xl overflow-hidden bg-neutral-600 ">
