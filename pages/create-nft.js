...
export default function createNFT() {
    ...
    async function createMarket() {
        ...
        if (!name || !description || !price || !fileUrl) return // Check Values
    ...
    return (
      <div className="flex justify-center">
        <div className="w-1/2 flex flex-col pb-12">
          ...
          <button onClick={createMarket} className="font-bold mt-4 bg-blue-300 text-white rounded p-4 shadow-lg">
